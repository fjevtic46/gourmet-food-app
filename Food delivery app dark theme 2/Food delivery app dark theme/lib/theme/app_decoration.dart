...
class AppDecoration {
  static BoxDecoration get txtOutlineGray10063 => BoxDecoration(
  ...
  static BoxDecoration get outlineGray10063 => BoxDecoration(
        color: ColorConstant.whiteA70063,
        border: Border.all(
          color: ColorConstant.gray10063,
          width: getHorizontalSize(
  ...
  static BoxDecoration get outlineIndigoA200111 => BoxDecoration(
  ...
  static BoxDecoration get outlineIndigoA200112 => BoxDecoration(
        color: ColorConstant.black900,
        boxShadow: [
          BoxShadow(
            color: ColorConstant.indigoA20011,
  ...
  static BoxDecoration get gradientGreenA20063GreenA70063 => BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment(
            0,
            -0.06,
  ...
  static BoxDecoration get outlineGray100631 => BoxDecoration(
        color: ColorConstant.whiteA70063,
        border: Border.all(
          color: ColorConstant.gray10063,
          width: getHorizontalSize(
  ...
  static BoxDecoration get outlineCyan90033 => BoxDecoration(
  ...
  static BoxDecoration get gradientGreenA200GreenA700 => BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment(
            0,
            -0.06,
...
class BorderRadiusStyle {
  ...
  static BorderRadius roundedBorder95 = BorderRadius.circular(
    getHorizontalSize(
      95.00,
    ),
  );
