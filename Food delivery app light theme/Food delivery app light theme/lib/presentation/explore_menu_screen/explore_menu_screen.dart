import '../explore_menu_screen/widgets/listmenuphoto_item_widget.dart';
...
class ExploreMenuScreen extends GetWidget<ExploreMenuController> {
  @override
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller
                        .exploreMenuModelObj.value.listmenuphotoItemList.length,
                    itemBuilder: (context, index) {
                      ListmenuphotoItemModel model = controller
                          .exploreMenuModelObj
                          .value
                          .listmenuphotoItemList[index];
                      return ListmenuphotoItemWidget(
                        model,
                      );
                    },
                  ),
