import '../explore_menu_with_filter_screen/widgets/listmenuphoto1_item_widget.dart';
...
class ExploreMenuWithFilterScreen
    extends GetWidget<ExploreMenuWithFilterController> {
  @override
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              CustomImageView(
                                svgPath:
                                    ImageConstant.imgCloseDeepOrange70018x18,
                                height: getSize(
                                  18.00,
                                ),
                                width: getSize(
                              ...
                              CustomTextFormField(
                                ...
                                hintText: "lbl_soup".tr,
                                variant: TextFormFieldVariant.FillYellow80063,
                                padding: TextFormFieldPadding.PaddingAll13,
                                fontStyle:
                                    TextFormFieldFontStyle.BentonSansMedium12,
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.exploreMenuWithFilterModelObj.value
                        .listmenuphoto1ItemList.length,
                    itemBuilder: (context, index) {
                      Listmenuphoto1ItemModel model = controller
                          .exploreMenuWithFilterModelObj
                          .value
                          .listmenuphoto1ItemList[index];
                      return Listmenuphoto1ItemWidget(
                        model,
                      );
                    },
                  ),
